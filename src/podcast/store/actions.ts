...
export const setPodcasts: ActionCreator<SetPodcastsAction> = (payload: PodcastData[]) => ({
...
export const setPodcastVolume: ActionCreator<SetPodcastVolume> = (payload: number) => ({
  type: PODCAST_ACTIONS.SET_VOLUME,
  payload,
});

export const setPodcastPlay: ActionCreator<SetPodcastPlay> = (payload: boolean) => ({
...
export const loadPodcasts = (): AppThunkAsync => async (dispatch): Promise<undefined> => {
  try {
